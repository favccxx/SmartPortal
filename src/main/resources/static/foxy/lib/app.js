...
var App = function() {
    ...
    function s() {
        var t = $(".be-scroller", n);
        function a() {
            i.removeClass(e.openRightSidebarClass).addClass(e.transitionClass),
            c()
        }
        n.length > 0 && ($(".be-toggle-right-sidebar").on("click",
        function(t) {
            r && i.hasClass(e.openRightSidebarClass) ? a() : r || (i.addClass(e.openRightSidebarClass + " " + e.transitionClass), r = !0),
            t.preventDefault()
        }), $(document).on("mousedown touchstart",
        function(t) { ! $(t.target).closest(n).length && i.hasClass(e.openRightSidebarClass) && (e.closeRsOnClickOutside || $.isSm()) && a()
        })),
        t.perfectScrollbar(),
        ...
        $('a[data-toggle="tab"]', n).on("shown.bs.tab",
        function(e) {
    ...
    function d() {
        ...
        function c(e, t) {
            ...
            "" != e && ($('<div class="msg">' + e + "</div>").appendTo(i), i.appendTo(o), n.stop().animate({
                scrollTop: n.prop("scrollHeight")
            },
            900, "swing"), n.perfectScrollbar("update"))
        }
        $(".user a", t).on("click",
        function(t) {
    ...
    return {
        ...
        init: function(u) {
            ...
            e.enableLeftSidebar ?
            function() {
                var t, n, l = $(".sidebar-elements > li > a", o),
                s = $(".sidebar-elements li a", o),
                d = $(".left-sidebar-scroll", o),
                p = $(".left-sidebar-toggle", o),
                u = !!e.openLeftSidebarOnClick;
                function f() {
                ...
                function m(t, i) {
                    ...
                    c = a.parents().eq(1).hasClass("sidebar-elements"); ! $.isSm() && g() && (c || l) ? (n.removeClass("open"), t.removeClass("visible"), r.removeClass("open").removeAttr("style")) : t.slideUp({
                        duration: s,
                        complete: function() {
                            n.removeClass("open"),
                ...
                a.hasClass(e.collapsibleSidebarClass) && (n = void 0 !== t ? t: $(".sidebar-elements > li", o), $.each(n,
                function() {
                ...
                }), $(".be-toggle-left-sidebar").on("click",
                function() {
                ...
                function() {
                    for (var t = $(".sidebar-elements > li > a", o), i = 0; i <= t.length; i++) {
                        var n = t[i],
                        r = $("> span", n).text();
                        $(n).attr({
                            "data-toggle": "tooltip",
                    ...
                    t.on("mouseenter",
                    function() { ! $.isSm() && a.hasClass(e.collapsibleSidebarCollapsedClass) && $(this).tooltip("show")
                    }),
                    t.on("mouseleave",
                    function() {
                        $(this).tooltip("hide")
                ...
                function(e) {
                    var t = $(this),
                    i = t.parent(),
                    a = i.find("> ul"); ! $.isSm() && g() && (a.length > 0 ? setTimeout(function() {
                        a.is(":hover") ? a.on("mouseleave",
                        function() {
                            setTimeout(function() {
                ...
                function(e) {
                    ...
                    i.siblings(".open"),
                    i.hasClass("open") ? m(a, e) : b(this, e),
                    t.next().is("ul") && e.preventDefault()
                }),
                a.hasClass(e.collapsibleSidebarCollapsedClass) ? $("li.active", o).parents(".parent").addClass("active") : $("li.active", o).parents(".parent").addClass("active open"),
                a.hasClass("be-fixed-sidebar") && ($.isSm() && !a.hasClass(e.offCanvasLeftSidebarClass) || d.perfectScrollbar(), $(window).resize(function() {
                    h(function() {
                ...
                function(t) {
                    ...
                    i.slideToggle(e.leftSidebarToggleSpeed,
                    function() {
                        $(this).removeAttr("style").toggleClass("open")
                    })
                }),
                a.hasClass(e.offCanvasLeftSidebarClass) && (e.toggleLeftSidebarButton.on("click",
                function(t) {
                    r && i.hasClass(e.openLeftSidebarClass) ? (i.removeClass(e.openLeftSidebarClass), c()) : (i.addClass(e.openLeftSidebarClass + " " + e.transitionClass), r = !0),
                    t.preventDefault()
                }), $(document).on("mousedown touchstart",
                function(t) {
            ...
            } () : a.addClass(e.disabledLeftSidebarClass),
            s(),
            d(),
            e.enableSwipe && a.swipe({
                allowPageScroll: "vertical",
                preventDefaultEvents: !1,
                fallbackToMouseEvents: !1,
                swipeLeft: function(t) { ! r && n.length > 0 && (i.addClass(e.openRightSidebarClass + " " + e.transitionClass), r = !0)
                },
                threshold: e.swipeTreshold
            }),
            e.scrollTop && ((f = $('<div class="be-scroll-top"></div>')).appendTo("body"), $(window).on("scroll",
            function() {
                $(this).scrollTop() > 220 ? f.fadeIn(500) : f.fadeOut(500)
            }), f.on("touchstart mouseup",
            function(e) {
                $("html, body").animate({
                    scrollTop: 0
                },
            ...
            t.primary = l("clr-primary"),
            t.success = l("clr-success"),
            t.warning = l("clr-warning"),
            t.danger = l("clr-danger"),
            t.grey = l("clr-grey"),
            $(".be-connections").on("click",
            function(e) {
                e.stopPropagation()
            }),
            p(),
...
function FastClick(e, t) {
    ...
    this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = t.touchBoundary || 10, this.layer = e, this.tapDelay = t.tapDelay || 200, !FastClick.notNeeded(e)) {
        ...
        Event.prototype.stopImmediatePropagation || (e.removeEventListener = function(t, i, a) {
...
FastClick.prototype.sendClick = function(e, t) {
    ...
    (o = document.createEvent("MouseEvents")).initMouseEvent("mousedown", !0, !0, window, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null),
    o.forwardedTouchEvent = !0,
    e.dispatchEvent(o),
    (a = document.createEvent("MouseEvents")).initMouseEvent("mouseup", !0, !0, window, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null),
        ...
        this.each(function() {
            ...
            function(t, T) {
                function _(t) {
                    if (! (!0 === Ce.data(x + "_intouch") || e(t.target).closest(T.excludedElements, Ce).length > 0)) {
                        ...
                        if (!r.pointerType || "mouse" != r.pointerType || 0 != T.fallbackToMouseEvents) {
                            ...
                            V(),
                            Z(0, c),
                            !s || Se === T.fingers || T.fingers === b || Y() ? (xe = ne(), 2 == Se && (Z(1, s[1]), me = be = ae(Ae[0].start, Ae[1].start)), (T.swipeStatus || T.pinchStatus) && (l = P(r, $e))) : l = !1,
                            !1 === l ? (P(r, $e = C), l) : (T.hold && (Le = setTimeout(e.proxy(function() {
                ...
                function M(t) {
                    ...
                    if ($e !== w && $e !== C && !Q()) {
                        ...
                        if (Te = ne(), x && (Se = x.length), T.hold && clearTimeout(Le), $e = y, 2 == Se && (0 == me ? (Z(1, x[1]), me = be = ae(Ae[0].start, Ae[1].start)) : (K(x[1]), be = ae(Ae[0].end, Ae[1].end), Ae[0].end, Ae[1].end, ye = ve < 1 ? l: r), ve = (be / me * 1).toFixed(2), ke = Math.abs(me - be)), Se === T.fingers || T.fingers === b || !x || Y()) {
                            if (he = oe(M.start, M.end), fe = oe(M.last, M.end),
                            function(e, t) {
                                if (!1 !== T.preventDefaultEvents) if (T.allowPageScroll === s) e.preventDefault();
                                else {
                            ...
                            } (t, fe), k = M.start, $ = M.end, ue = Math.round(Math.sqrt(Math.pow($.x - k.x, 2) + Math.pow($.y - k.y, 2))), ge = ie(), v = ue, (f = he) != s && (v = Math.max(v, ee(f)), we[f].distance = v), A = P(S, $e), !T.triggerOnTouchEnd || T.triggerOnTouchLeave) {
                                var E = !0;
                                if (T.triggerOnTouchLeave) {
                                    ...
                                    d = M.end,
                                    p = F,
                                    E = d.x > p.left && d.x < p.right && d.y > p.top && d.y < p.bottom
                                } ! T.triggerOnTouchEnd && E ? $e = I(y) : T.triggerOnTouchLeave && !E && ($e = I(w)),
                                $e != C && $e != w || P(S, $e)
                            }
                        } else P(S, $e = C); ! 1 === A && P(S, $e = C)
                    }
                }
                function E(e) {
                    ...
                    Te = ne(),
                    ge = ie(),
                    H() || !O() ? P(i, $e = C) : T.triggerOnTouchEnd || !1 === T.triggerOnTouchEnd && $e === y ? (!1 !== T.preventDefaultEvents && !1 !== e.cancelable && e.preventDefault(), P(i, $e = w)) : !T.triggerOnTouchEnd && U() ? R(i, $e = w, u) : $e === y && P(i, $e = C),
                    J(!1),
                    null
                }
                function F() {
                ...
                function L(e) {
                    ...
                    T.triggerOnTouchLeave && ($e = I(w), P(t, $e))
                }
                function D() {
                    Ce.unbind(le, _),
                    Ce.unbind(pe, F),
                ...
                function I(e) {
                    ...
                    a = O(),
                    o = H();
                    return ! i || o ? t = C: !a || e != y || T.triggerOnTouchEnd && !T.triggerOnTouchLeave ? !a && e == w && T.triggerOnTouchLeave && (t = C) : t = w,
                    t
                }
                function P(e, t) {
                    var i, a = e.touches;
                    return (! (!z() || !W()) || W()) && (i = R(e, t, d)),
                    (!(!N() || !Y()) || Y()) && !1 !== i && (i = R(e, t, p)),
                    G() && X() && !1 !== i ? i = R(e, t, h) : ge > T.longTapThreshold && ue < v && T.longTap && !1 !== i ? i = R(e, t, f) : !(1 !== Se && $ || !(isNaN(ue) || ue < T.threshold) || !U()) && !1 !== i && (i = R(e, t, u)),
                    t === C && F(),
                    t === w && (a && a.length || F()),
                    i
                }
                function R(t, s, c) {
                    ...
                    if (c == d) {
                        ...
                        if (s == w && z()) {
                            ...
                            switch (he) {
                            case i:
                                Ce.trigger("swipeLeft", [he, ue, ge, Se, Ae, fe]),
                                T.swipeLeft && (g = T.swipeLeft.call(Ce, t, he, ue, ge, Se, Ae, fe));
                                break;
                            case a:
                                Ce.trigger("swipeRight", [he, ue, ge, Se, Ae, fe]),
                                T.swipeRight && (g = T.swipeRight.call(Ce, t, he, ue, ge, Se, Ae, fe));
                                break;
                            case o:
                                Ce.trigger("swipeUp", [he, ue, ge, Se, Ae, fe]),
                                T.swipeUp && (g = T.swipeUp.call(Ce, t, he, ue, ge, Se, Ae, fe));
                                break;
                            case n:
                                Ce.trigger("swipeDown", [he, ue, ge, Se, Ae, fe]),
                                T.swipeDown && (g = T.swipeDown.call(Ce, t, he, ue, ge, Se, Ae, fe))
                            }
                        }
                    }
                    if (c == p) {
                        ...
                        if (s == w && N()) switch (ye) {
                        case r:
                            Ce.trigger("pinchIn", [ye || null, ke || 0, ge || 0, Se, ve, Ae]),
                            T.pinchIn && (g = T.pinchIn.call(Ce, t, ye || null, ke || 0, ge || 0, Se, ve, Ae));
                            break;
                        case l:
                            Ce.trigger("pinchOut", [ye || null, ke || 0, ge || 0, Se, ve, Ae]),
                            T.pinchOut && (g = T.pinchOut.call(Ce, t, ye || null, ke || 0, ge || 0, Se, ve, Ae))
                        }
                    }
                    return c == u ? s !== C && s !== w || (clearTimeout(Fe), clearTimeout(Le), X() && !G() ? (Ee = ne(), Fe = setTimeout(e.proxy(function() {
                        Ee = null,
                        Ce.trigger("tap", [t.target]),
                        T.tap && (g = T.tap.call(Ce, t, t.target))
                    },
                    this), T.doubleTapThreshold)) : (Ee = null, Ce.trigger("tap", [t.target]), T.tap && (g = T.tap.call(Ce, t, t.target)))) : c == h ? s !== C && s !== w || (clearTimeout(Fe), clearTimeout(Le), Ee = null, Ce.trigger("doubletap", [t.target]), T.doubleTap && (g = T.doubleTap.call(Ce, t, t.target))) : c == f && (s !== C && s !== w || (clearTimeout(Fe), Ee = null, Ce.trigger("longtap", [t.target]), T.longTap && (g = T.longTap.call(Ce, t, t.target)))),
                    g
                }
                function O() {
                    var e = !0;
                    return null !== T.threshold && (e = ue >= T.threshold),
                    e
                }
                function H() {
                    var e = !1;
                    return null !== T.cancelThreshold && null !== he && (e = ee(he) - ue >= T.cancelThreshold),
                    e
                }
                function B() {
                ...
                function G() {
                    if (null == Ee) return ! 1;
                    var e = ne();
                    return X() && e - Ee <= T.doubleTapThreshold
                }
                function V() {
                    _e = 0,
                    Me = 0
                ...
                function J(e) {
                    Ce && (!0 === e ? (Ce.bind(se, M), Ce.bind(ce, E), de && Ce.bind(de, L)) : (Ce.unbind(se, M, !1), Ce.unbind(ce, E, !1), de && Ce.unbind(de, L, !1)), Ce.data(x + "_intouch", !0 === e))
                }
                function Z(e, t) {
                    var i = {
                        start: {
                ...
                var T = e.extend({},
                T),
                re = $ || A || !T.fallbackToMouseEvents,
                le = re ? A ? S ? "MSPointerDown": "pointerdown": "touchstart": "mousedown",
                se = re ? A ? S ? "MSPointerMove": "pointermove": "touchmove": "mousemove",
                ce = re ? A ? S ? "MSPointerUp": "pointerup": "touchend": "mouseup",
                de = re ? A ? "mouseleave": null: "mouseleave",
                pe = A ? S ? "MSPointerCancel": "pointercancel": "touchcancel",
                ue = 0,
                he = null,
                fe = null,
                ge = 0,
...
function(e) {
    function t(i, a) {
        ...
        d = !0, p = "%" === String(o.r).substr( - 1) ? "prgb": "rgb") : T(o.h) && T(o.s) && T(o.v) ? (l = S(o.s), s = S(o.v), n = function(t, i, a) {
            ...
            var o, n, r;
            if (e = y(e, 360), t = y(t, 100), i = y(i, 100), 0 === t) o = n = r = i;
            else {
        ...
        this._format = a.format || g.format,
    ...
    function d(e, i) {
        i = 0 === i ? 0 : i || 10;
        var a = t(e).toRgb();
        return a.r = D(0, L(255, a.r - F( - i / 100 * 255))),
        a.g = D(0, L(255, a.g - F( - i / 100 * 255))),
        a.b = D(0, L(255, a.b - F( - i / 100 * 255))),
        t(a)
    }
    function p(e, i) {
        i = 0 === i ? 0 : i || 10;
    ...
    function b(e, i, a) {
        ...
        n = 360 / a,
        r = [t(e)];
        for (o.h = (o.h - (n * i >> 1) + 720) % 360; --i;) o.h = (o.h + n) % 360,
        r.push(t(o));
        return r
    }
    function v(e, i) {
    ...
    function y(t, i) {
        ...
        return t = L(i, D(0, parseFloat(t))),
        n && (t = parseInt(t * i, 10) / 100),
    ...
    t.prototype = {
        ...
        getLuminance: function() {
            ...
            i = o.g / 255,
            a = o.b / 255,
            .2126 * (.03928 >= t ? t / 12.92 : e.pow((t + .055) / 1.055, 2.4)) + .7152 * (.03928 >= i ? i / 12.92 : e.pow((i + .055) / 1.055, 2.4)) + .0722 * (.03928 >= a ? a / 12.92 : e.pow((a + .055) / 1.055, 2.4))
        },
        setAlpha: function(e) {
            return this._a = k(e),
            this._roundA = F(100 * this._a) / 100,
        ...
        toHex8: function(e) {
            ...
            o = this._a,
            n = e,
            r = [$(F(t).toString(16)), $(F(i).toString(16)), $(F(a).toString(16)), $(A(o))],
            n && r[0].charAt(0) == r[0].charAt(1) && r[1].charAt(0) == r[1].charAt(1) && r[2].charAt(0) == r[2].charAt(1) && r[3].charAt(0) == r[3].charAt(1) ? r[0].charAt(0) + r[1].charAt(0) + r[2].charAt(0) + r[3].charAt(0) : r.join("");
            var t, i, a, o, n, r
    ...
    N = (R = "[\\s|\\(]+(" + (P = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + P + ")[,|\\s]+(" + P + ")\\s*\\)?", O = "[\\s|\\(]+(" + P + ")[,|\\s]+(" + P + ")[,|\\s]+(" + P + ")[,|\\s]+(" + P + ")\\s*\\)?", {
...
App = function() {
    ...
    return App.ChartJs = function() {
        ...
        v = App.color.primary,
        k = tinycolor(App.color.primary).lighten(12).toString(),
        y = tinycolor(App.color.primary).lighten(22).toString(),
        w = document.getElementById("pie-chart"),
        new Chart(w, {
            type: "pie",
            data: {
        ...
        A = document.getElementById("donut-chart"),
        new Chart(A, {
            type: "doughnut",
            data: {
                labels: ["Red", "Blue", "Yellow"],
...
App = function() {
    ...
    return App.chartsMorris = function() {
        ...
        a = tinycolor(App.color.success).brighten(3).toString(),
        Morris.Bar({
            element: "bar-chart",
            data: [{
                device: "iPhone",
...
App = function() {
    ...
    return App.chartsSparklines = function() {
        ...
        var o = tinycolor(App.color.primary),
        ...
        $.fn.sparkline.defaults.common.fillColor = o.setAlpha(.3).toString(),
        ...
        $.fn.sparkline.defaults.bullet.rangeColors[0] = n.setAlpha(.2).toString(),
        $.fn.sparkline.defaults.bullet.rangeColors[1] = n.setAlpha(.5).toString(),
        $.fn.sparkline.defaults.bullet.rangeColors[2] = n.setAlpha(.45).toString(),
        ...
        $.fn.sparkline.defaults.box.boxFillColor = n.setAlpha(.5).toString(),
        $.fn.sparkline.defaults.box.boxLineColor = e,
        $.fn.sparkline.defaults.box.whiskerColor = a,
...
App = function() {
    ...
    return App.dashboard = function() {
        ...
        $('[data-toggle="counter"]').each(function(e, t) {
            ...
            l = 0,
            s = 2.5;
            i.data("prefix") && (a = i.data("prefix")),
            i.data("suffix") && (o = i.data("suffix")),
            i.data("start") && (n = i.data("start")),
            i.data("end") && (r = i.data("end")),
            i.data("decimals") && (l = i.data("decimals")),
            i.data("duration") && (s = i.data("duration")),
            new CountUp(i.get(0), n, r, l, s, {
                suffix: o,
                prefix: a
            }).start()
        }),
...
App = function() {
    ...
    return App.formElements = function() {
        ...
        $(".inputfile").each(function() {
            ...
            function(e) {
                var a = "";
                this.files && this.files.length > 1 ? a = (this.getAttribute("data-multiple-caption") || "").replace("{count}", this.files.length) : e.target.value && (a = e.target.value.split("\\").pop()),
                a ? t.find("span").html(a) : t.html(i)
            })
        })
    },
    App
    ...
    return App.formMultiselect = function() {
        ...
        $("#searchable").multiSelect({
            ...
            afterInit: function(e) {
                ...
                o = "#" + t.$container.attr("id") + " .ms-elem-selectable:not(.ms-selected)",
                n = "#" + t.$container.attr("id") + " .ms-elem-selection.ms-selected";
                t.qs1 = i.quicksearch(o).on("keydown",
                function(e) {
                    if (40 === e.which) return t.$selectableUl.focus(),
                    !1
                }),
                t.qs2 = a.quicksearch(n).on("keydown",
                function(e) {
                    if (40 == e.which) return t.$selectionUl.focus(),
                    !1
                })
            },
...
App = function() {
    ...
    return App.wizard = function() {
        $(".wizard-ux").wizard(),
        $(".wizard-ux").on("changed.fu.wizard",
        function() {
            $(".bslider").slider()
        }),
        ...
        $("#credit_slider").slider().on("slide",
        function(e) {
            $("#credits").html("$" + e.value)
        }),
        $("#rate_slider").slider().on("slide",
        function(e) {
            $("#rate").html(e.value + "%")
        })
    },
        ...
        function() {
            ...
            if ("all" == o.val() ? i.show() : $("#" + o.val()).show(), n) {
                ...
                function(e, t) {
                    ...
                    return i && a.indexOf(e.category) < 0 && a.push(e.category),
                    i
                });
                $.each(r,
                function(e, t) {
                ...
                i.not(a).hide().addClass("icon-category--hide-icons")
...
App = function() {
    ...
    return App.megaMenu = function() {
        ...
        $(".be-sub-header .nav-link, .be-sub-header .dropdown-item", e).on("click",
        function(e) {
            var i = $(this),
            a = i.parent(),
            o = a.siblings(".open"),
            n = i.next("." + t.subNavClass),
            r = t.leftSidebarSlideSpeed;
            function l(e) {
                var i = $(e).parent(),
                a = $(".nav-item.open, ." + t.megaMenuSectionClass + ".open", i);
                e.slideUp({
                    duration: r,
                    complete: function() {
                        i.removeClass("open"),
            ...
            $.isSm() ? (n.length && (a.hasClass("open") ? l(n) : function(e) {
                var i = e.parent(),
                a = !1;
                if (a = i.siblings(".open"), i.hasClass(t.megaMenuSectionClass)) {
                    var o = i.parent();
                    a = a.add(o.siblings().find("." + t.megaMenuSectionClass + ".open"))
                }
                a && l($("> ." + t.subNavClass, a)),
                e.slideDown({
                    duration: r,
            ...
            } (n), e.preventDefault()), e.stopPropagation()) : a.parent().hasClass("navbar-nav") && n.length && (o.removeClass("open"), a.addClass("open"), e.preventDefault())
        }),
        $(window).resize(function() {
            a(function() {
                var t;
...
//        $(".bslider").bootstrapSlider(),
        ...
        $.fn.dataTable.ext.search.push(function(e, t, i, a, o) {
            ...
            p = new Date($(".date", e.aoData[i].anCells[5]).html()),
            u = $("#toDo").is(":checked"),
            h = $("#inProgress").is(":checked"),
            f = $("#inReview").is(":checked"),
            g = $("#done").is(":checked"),
            m = $(e.aoData[i].nTr).attr("class").split(" ");
            return parseInt(r[1]) >= parseInt(n[0]) && parseInt(r[1]) <= parseInt(n[1]) && ((l == s || "All" == l) && (p >= c && p <= d && (0 == u && 0 == h && 0 == f && 0 == g || 1 == u && "to-do" == m[1] || 1 == h && "in-progress" == m[1] || 1 == f && "in-review" == m[1] || 1 == g && "done" == m[1])))
        });
        var e = $("#fileHistoryTable").DataTable({
            pageLength: 5,
            dom: "<'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>"
        });
        $("#milestone_slider").slider().on("slide",
        function(t) {
            var i = t.value[0],
            a = t.value[1];
            $("#slider-value").html(i + "% - " + a + "%"),
            e.draw()
        }),
        $(".select2").on("change",
        function() {
        ...
        $("#dateSince, #dateTo").on("change",
        function() {
            e.draw()
        }),
        $("#toDo, #inProgress, #inReview, #done").on("click",
        function() {
            e.draw()
        })
    },
